...
//    }
    ...
    public class FindStudentById{
        ...
        void findStudentByIdForException() {
            //given
            Long studentId = 12L;
            //we getting empty objcet from database/ when requested id is not found from DB
    ...
    @Test
    @DisplayName("UpdateStudent when new email is not exist in DB and are updating data")
    void updateStudent() {
        //given
        ...
        //we are assuming that new email does not exist in BD
        ...
        //
        verify(studentRepository).existsByEmail("sinan@gmail.com"); //verifying existsByEmail is running with new wmail
        verify(studentRepository, times(1)).save(student1); //verifying save method is running
    ...
    //Helper method to create a list of mock studetns
